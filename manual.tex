...
\subsection{常用流量识别方法}
我们常用的包括基于传输层端口的识别、基于深度包检测的识别、基于主机行为分析方法的识别和基于对数据包统计分析方法的识别在内的识别方法都属于被动识别，其被广泛用于流量拦截以保障网络安全、流量统计以优化网络带宽配置等。被动识别从流量识别级别上可分为数据包级别和流级别识别，基于传输层端口的识别和基于深度包检测的识别属于数据包级别的识别方法，基于主机行为分析方法的识别和基于对数据包统计分析方法的识别属于流级别的识别方法。



\subsection{VoIP流量识别研究}
VoIP协议种类繁杂的特性决定了VoIP流量较常见的网络流量识别难度要高。
